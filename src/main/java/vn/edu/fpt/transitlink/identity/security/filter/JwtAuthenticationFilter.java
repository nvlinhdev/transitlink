package vn.edu.fpt.transitlink.identity.security.filter;
    ...
    protected void doFilterInternal(
        ...
        try {
            ...
            if (userEmail != null && SecurityContextHolder.getContext().getAuthentication() == null) {
                CustomUserPrincipal userDetails = (CustomUserPrincipal) userDetailsService.loadUserByUsername(userEmail);
