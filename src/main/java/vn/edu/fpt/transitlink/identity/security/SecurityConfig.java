...
import vn.edu.fpt.transitlink.identity.security.filter.JwtAuthenticationFilter;
import vn.edu.fpt.transitlink.identity.security.oidc.CustomOidcUserService;
import vn.edu.fpt.transitlink.identity.security.oidc.HttpCookieOAuth2AuthorizationRequestRepository;
import vn.edu.fpt.transitlink.identity.security.oidc.JwtAuthenticationSuccessHandler;
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http.csrf(AbstractHttpConfigurer::disable)
                ...
                .authorizeHttpRequests(authz -> {
                    authz.requestMatchers("/api/identity/auth/password/set").authenticated();
                    authz.requestMatchers("/api/identity/auth/password/change").authenticated();
