...
# Validate all required backup files exist
echo "Checking backup files..."
BACKUP_ERRORS=0

# Check app database backup
...
# Check keycloak database backup
...
# Get the most recent backup files for the rollback tag
